...
function resetTest() {
    var resetAction = [];
    resetAction.push(clickControl([areaOfClass, "ResetButton"]));
    resetAction.push(log("after test reset"));
    return (new MoonOrderedSet(resetAction));
};
